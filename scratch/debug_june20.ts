...
async function main() {
  ...
  const eventsAtDate = activeSeason.scheduled_events.filter(s => s.starts_at.startsWith('2026-06-20') && s.conference === 'EU_IBIT');
  console.log('Scheduled Events at 2026-06-20 (EU_IBIT):', JSON.stringify(eventsAtDate, null, 2));
