                    ...
                    <>
                        ...
                        >
                            {[
                                {
                                    label: "K/D Ratio",
                                    value: data.stats?.kdRatio || "0.0",
                                    color: "var(--val-red)",
                                },
                                {
                                    label: "Win Rate",
                                    value: `${data.stats?.winRate || 0}%`,
                                    color: "var(--val-cyan)",
                                },
                                {
                                    label: "Avg Score",
                                    value: data.stats?.avgACS || 0,
                                    color: "var(--val-purple)",
                                },
                                {
                                    label: "HS Percentage",
                                    value: `${data.stats?.headshotPct || 0}%`,
                                    color: "var(--val-yellow)",
                                },
                            ].map((s) => (
                                <div
                        ...
                        >
                            ...
                            <div className="card glass-card">
                                <div className="card-header">
                                    ...
                                    >
                                        {data.stats?.gamesPlayed || 0} Games
                                    </div>
                                </div>
                                <div
                                    style={{
                            ...
                            <div className="card glass-card">
                                ...
                                >
                                    {Object.values(data.stats?.agentStats || {})
                                                ...
                                                >
                                                    <td
                                                        style={{
                                                            ...
                                                            borderRadius:
                                                                "8px 0 0 8px",
                                                            borderLeft: `4px solid ${won ? "var(--val-cyan)" : "var(--val-red)"}`,
                                                        }}
                                                    >
                                                        <div
                                                            style={{
                                                        ...
                                                        >
                                                            <span
                                                                className={`form-indicator ${won ? "form-w" : "form-l"}`}
                                                                style={{
                                                                    width: 24,
                                                                    height: 24,
                                                                    fontSize: 10,
