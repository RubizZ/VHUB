...
function PremierStats() {
  ...
  return (
    <div key="premier-data" className="grid grid-3" style={{ marginBottom: 32, gap: 20 }}>
      ...
      <Link href="/leaderboard" className="card stat-card hover-lift" style={{ background: "linear-gradient(135deg, rgba(212, 175, 55, 0.08) 0%, rgba(20, 20, 20, 0) 100%)", borderLeft: "4px solid var(--val-gold)", '--glow-color': 'var(--val-gold)', textDecoration: "none", color: "inherit" } as any}>
